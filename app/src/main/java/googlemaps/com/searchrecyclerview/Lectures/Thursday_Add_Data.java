...
public class Thursday_Add_Data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tym.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(Thursday_Add_Data.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Thursday_Model thurModel = new Thursday_Model(activity, time, venue);
                thurModel.save();
