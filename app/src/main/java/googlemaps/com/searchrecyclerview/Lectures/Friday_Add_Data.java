...
public class Friday_Add_Data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tym.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(Friday_Add_Data.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Friday_Model assignmentsModel = new Friday_Model(activity,time,venue);
                assignmentsModel.save();
