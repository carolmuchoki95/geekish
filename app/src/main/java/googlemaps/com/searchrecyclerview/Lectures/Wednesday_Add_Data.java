...
public class Wednesday_Add_Data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tym.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(Wednesday_Add_Data.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Wednesday_Model wedModel = new Wednesday_Model(activity,time,venue);
                wedModel.save();
