...
public class Thursday_Add_Adapter extends BaseAdapter {
    private LayoutInflater inflater;
    public ViewHolder holder = null;
    private List<Thursday_Model> thursday_models = new ArrayList<>();

    Thursday_Add_Adapter(Context context, List<Thursday_Model> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.activity.setText(this.thursday_models.get(position).activity);
        holder.time.setText(this.thursday_models.get(position).time);
        holder.venue.setText(this.thursday_models.get(position).venue);
