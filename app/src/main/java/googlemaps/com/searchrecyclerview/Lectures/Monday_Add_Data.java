...
public class Monday_Add_Data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tym.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(Monday_Add_Data.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Monday_Model assignmentsModel = new Monday_Model(activity,time,venue);
